...
process.otdtccablingmap_producer = cms.EDAnalyzer("DTCCablingMapProducer",
    ...
    modulesToDTCCablingCSVFileNames = cms.vstring(
     "CondTools/SiPhase2Tracker/test/cablingMap_noHeader.csv"
    ),
    #dummy_fill_mode = cms.string("DUMMY_FILL_ELINK_ID_AND_GBT_ID"),
    csvFormat_ncolumns   = cms.uint32( 18),
    csvFormat_idetid     = cms.uint32( 0),
    csvFormat_idtcid     = cms.uint32( 14),
    csvFormat_igbtlinkid = cms.uint32( 12),
    #csvFormat_ielinkid   = cms.uint32( 5),
    csvFormat_ilayer     = cms.uint32( 2),
    csvFormat_iring      = cms.uint32( 3),
    csvFormat_isubdet    = cms.uint32( 1),
    csvFormat_izplus     = cms.uint32( 16),
    csvFormat_ixplus     = cms.uint32( 17), 
